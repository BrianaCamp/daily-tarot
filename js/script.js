...
var arrayOfCards = [
  ...
  },
  {
    ...
    reverse : "Reversed: Expedition, dispatch, achievement, end. It signifies also the side of excess in physical enjoyment, and the pleasures of the senses.",
    category : "cups"
  ...
  },
  {
    ...
    description : "A man of dejected aspect is deserting the cups of his felicity, enterprise, undertaking or previous concern. Divinatory Meanings: The card speaks for itself on the surface, but other readings are entirely antithetical - giving joy, mildness, timidity, honour, modesty. In practice, it is usually found that the card shews the decline of a matter, or that a matter which has been thought to be important is really of slight consequence - either for good or evil. Reversed: Great joy, happiness, feasting.",
    reverse : "",
    category : "cups"
  ...
  },
  {
    ...
    reverse : "Reversed: Benevolence, compassion, credit; also confusion to enemies, obstruction, immaturity.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Negligence, absence, distribution, carelessness, apathy, nullity, vanity.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Concealment, disguise, policy, fear, unreasoned caution.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Society, good understanding, concord, overkindness, weakness.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Passion, moral or physical ardour, conceit, surface knowledge.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Weakness, pusillanimity, simplicity; also deliberation, decision, sentence.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Law in all its departments, legal complications, bigotry, bias, excessive severity.",
    category : "major"
  ...
  },
  {
    ...
    reverse : "Reversed: Mediocrity, in work and otherwise, puerility, pettiness, weakness.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Suspense, delay, opposition.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Disorder, chaos, ruin, discord, profligacy.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Desire, cupidity, envy, jealousy, illusion.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Cause for anxiety regarding money which it may be proposed to lend.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Voided ambition, vanity, cupidity, exaction, usury. It may also signify the possession of skill, in the sense of the ingenious mind turned to cunning and intrigue.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Roguery, deception, voided project, bad faith.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Chance, fatality, loss, robbery, games of hazard; sometimes gift, dowry, pension.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Prodigality, dissipation, liberality, luxury; unfavourable news.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: inertia, idleness, repose of that kind, stagnation; also placidity, discouragement, carelessness.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Evil, suspicion, suspense, fear, mistrust.",
    category : "pentacles"
  ...
  },
  {
    ...
    reverse : "Reversed: Vice, weakness, ugliness, perversity, corruption, peril.",
  ...
  },
  {
    ...
    reverse : "Reversed: Imposture, falsehood, duplicity, disloyalty.",
    category : "swords"
  ...
  },
  {
    ...
    reverse : "Reversed: Mental alienation, error, loss, distraction, disorder, confusion.",
    category : "swords"
  ...
  },
  {
    ...
    reverse : "Reversed: Wise administration, circumspection, economy, avarice, precaution, testament.",
    category : "swords"
  ...
  },
  {
    ...
    reverse : "Reversed: The same; burial and obsequies.",
    category : "swords"
  ...
  },
  {
    ...
    reverse : "Reversed: Declaration, confession, publicity; one account says that it is a proposal of love.",
    category : "swords"
  ...
  },
  {
    ...
    reverse : "Reversed: Good advice, counsel, instruction, slander, babbling.",
    category : "swords"
  ...
  },
   {
    ...
    reverse : "Reversed: Disquiet, difficulty, opposition, accident, treachery; what is unforeseen; fatality.",
    category : "swords"
  },
    {
    name : "Nine of Swords",
    ...
    reverse : "Reversed: Imprisonment, suspicion, doubt, reasonable fear, shame.",
    category : "swords"
    ...
    reverse : "Reversed: Advantage, profit, success, favour, but none of these are permanent; also power and authority.",
    category : "swords"
    ...
    reverse : "Reversed: More evil side of these qualities; what is unforeseen, unprepared state; sickness is also intimated.",
    category : "swords"
    ...
    reverse : "Reversed: Imprudence, incapacity, extravagance.",
    category : "swords"
    ...
    reverse : "Reversed: Malice, bigotry, artifice, prudery, bale, deceit.",
    category : "swords"
    ...
    reverse : "Reversed: Cruelty, perversity, barbarity, perfidy, evil intention.",
    category : "swords"
    ...
    reverse : "Reversed: Things connected with churches, religions, sects, the priesthood, sometimes even the priest who will marry the Querent; also disunion, unfortunate combinations, competing interests.",
    category : "major"
    ...
    reverse : "Reversed: According to one account, the same in a lesser degree also oppression, imprisonment, tyranny.",
    category : "major"
    ...
    reverse : "Reversed: Fall, decadence, ruin, perdition, to perish also a certain clouded joy.",
    category : "wands"
    ...
    reverse : "Reversed: Surprise, wonder, enchantment, emotion, trouble, fear.",
    category : "wands"
    ...
    reverse : "Reversed: The end of troubles, suspension or cessation of adversity, toil and disappointment.",
    category : "wands"
    ...
    reverse : "Reversed: The meaning remains unaltered; it is prosperity, increase, felicity, beauty, embellishment.",
    category : "wands"
    ...
    reverse : "Reversed: Litigation, disputes, trickery, contradiction.",
    category : "wands"
    ...
    reverse : "Reversed: Apprehension, fear, as of a victorious enemy at the gate; treachery, disloyalty, as of gates being opened to the enemy; also indefinite delay.",
    category : "wands"
    ...
    reverse : "Reversed: Perplexity, embarrassments, anxiety. It is also a caution against indecision.",
    category : "wands"
  ...
  },
   {
    ...
    reverse : "Reversed: Arrows of jealousy, internal dispute, stingings of conscience, quarrels; and domestic disputes for persons who are married.",
    category : "wands"
  ...
  },
  {
    ...
    reverse : "Reversed: Obstacles, adversity, calamity.",
    category : "wands"
  ...
  },
   {
    ...
    reverse : "Reversed: Contrarieties, difficulties, intrigues, and their analogies.",
    category : "wands"
    ...
    reverse : "Reversed: Anecdotes, announcements, evil news. Also indecision and the instability which accompanies it.",
    category : "wands"
  ...
  },
   {
    ...
    reverse : "Reversed: Rupture, division, interruption, discord.",
    category : "wands"
    ...
    reverse : "Reversed: Good, economical, obliging, serviceable. Signifies also - but in certain positions and in the neighbourhood of other cards tending in such directions - opposition, jealousy, even deceit and infidelity.",
    category : "wands"
    ...
    reverse : "Reversed: Good, but severe; austere, yet tolerant.",
    category : "wands"
  ...
  },
   {
    ...
    reverse : "Reversed: Increase, abundance, superfluity.",
    category : "major"
  ...
  },
   {
    ...
    reverse : "Reversed: Inertia, fixity, stagnation, permanence.",
    category : "major"
